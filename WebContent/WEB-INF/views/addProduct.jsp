...
<ul>
	...
	<div class="banner-top">
		<div class="container">
			...
			<em></em>
			<h2>
				<a href="${pageContext.request.contextPath}/">Home</a><label>/</label>Add
				Product
			</h2>
		</div>
	</div>
			...
			<form action="${pageContext.request.contextPath}/admin/addProduct"
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="hidden" name="productId"
							value="${productForm.productID}" /> <input name="productName"
				...
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-2 control-label">Enter
						date of addition</label>
					<div class="col-sm-4">
						<input type="date" name="productSaveDate" class="form-control"
							placeholder="Enter date" required=""
							value="${productForm.productSaveDate}" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input name="stock" class="form-control"
							value="${productForm.stock}" placeholder="Stock" required="" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input name="price" class="form-control"
							value="${productForm.price}" placeholder="Price" required />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<select name="categoryId">
							<c:if test="${productForm.category.catId!=null}">
								<option value="${productForm.category.catId}">${productForm.category.categoryName}</option>
							</c:if>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="supplierId">
							...
							<c:if test="${productForm.supplier.supplierId!=null}">
								<option value="${productForm.supplier.supplierId}">${productForm.supplier.supplierName}</option>
							</c:if>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<textarea name="description" class="form-control" rows="3"
							...
							placeholder="Price" required>${productForm.description}</textarea>
					</div>
				</div>
				<!--  -->
				...
				<button type="submit" class="btn btn-lg btn-info"
					style="margin-left: 200px;">Done!</button>
