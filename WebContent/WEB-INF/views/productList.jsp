...
<div class="banner-top">
	<div class="container">
		<h1>Product List</h1>
		<em></em>
		<h2><a href="index.html">Home</a><label>/</label>Product List</h2>
	</div>
</div>
<!--login-->
<div class="container">
    ...
    <table class="table">
      ...
      <c:forEach items="${productList}" var="product">
        <tr>
          ...
          <td><c:out value="${product.productSaveDate}"/></td>
          <td><c:out value="${product.stock}"/></td>
          <td><c:out value="${product.price}"/></td>
          <td><img src="<c:out value="${pageContext.request.contextPath}/resources/images/${product.imageName}"/>" height="60px" width="60px"/></td>
          
         <td><button class="btn btn-danger btn-xs" onclick="location.href='${pageContext.request.contextPath}/admin/deleteProduct/${product.productID}'">Delete</button></td>
         <td><button class="btn btn-success btn-xs" onclick="location.href='${pageContext.request.contextPath}/admin/updateProduct/${product.productID}'">Edit</button></td>
        </tr>
       </c:forEach>
