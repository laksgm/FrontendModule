...
<div class="banner-top">
	<div class="container">
		<h1>Category List</h1>
		<em></em>
		<h2><a href="${pageContext.request.contextPath}/">Home</a><label>/</label>Category List</h2>
	</div>
</div>
<!--login-->
<div class="container">
    ...
    <table class="table">
      ...
      <c:forEach items="${categoryList}" var="categoryList">
        <tr>
          ...
          <td><c:out value="${categoryList.categoryDate}"/></td>
          <td><c:out value="${categoryList.categoryAddedBy}"/></td>
          <td><c:out value="${categoryList.categoryDescription}"/></td>
         <td><button class="btn btn-danger btn-xs" onclick="location.href='${pageContext.request.contextPath}/admin/deleteCategory/${categoryList.catId}'">Delete</button></td>
         <td><button class="btn btn-success btn-xs" onclick="location.href='${pageContext.request.contextPath}/admin/updateCategory/${categoryList.catId}'">Edit</button></td>
        </tr>
       </c:forEach>
