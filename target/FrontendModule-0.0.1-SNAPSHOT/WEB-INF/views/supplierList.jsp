    ...
    <table class="table">
      ...
      <c:forEach items="${supplierList}" var="supplier">
        <tr>
         ...
         <td><button class="btn btn-danger btn-xs" onclick="location.href='${pageContext.request.contextPath}/deleteSupplier/${supplier.supplierId}'">Delete</button></td>
         <td><button class="btn btn-success btn-xs" onclick="location.href='${pageContext.request.contextPath}/updateSupplier/${supplier.supplierId}'">Edit</button></td>
        </tr>
       </c:forEach>
