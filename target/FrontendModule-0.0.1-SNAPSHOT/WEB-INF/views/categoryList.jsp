    ...
    <table class="table">
      ...
      <c:forEach items="${categoryList}" var="categoryList">
        <tr>
         ...
         <td><button class="btn btn-danger btn-xs" onclick="location.href='${pageContext.request.contextPath}/deleteCategory/${categoryList.catId}'">Delete</button></td>
         <td><button class="btn btn-success btn-xs" onclick="location.href='${pageContext.request.contextPath}/updateCategory/${categoryList.catId}'">Edit</button></td>
        </tr>
       </c:forEach>
