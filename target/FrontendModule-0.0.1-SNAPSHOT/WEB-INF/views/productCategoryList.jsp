...
<!---//End-rate---->
<link href="${mainCss}/form.css" rel="stylesheet" type="text/css"
	media="all" />
</head>
<body>
	<!--header-->
		...
		<div class="container">
			...
			<div class="head-top">
											...
											<div class="col1">
												<div class="h_nav">
													...
													<ul>
														...
														<li><a href="product.html">Shoes, Boots &
																Trainers</a></li>
								...
								<li class="dropdown mega-dropdown active"><a class="color2"
									...
									<div class="dropdown-menu mega-dropdown-menu">
										<div class="menu-top">
											...
											<div class="col1 col5">
												<img
													src="${pageContext.request.contextPath}/resources/images/me1.png"
													class="img-responsive" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
				...
				<div class="col-sm-2 search-right">
					...
					<!---pop-up-box---->
					<link href="${mainCss}/popuo-box.css" rel="stylesheet"
	...
	<div class="banner-top">
		<div class="container">
			...
			<em></em>
			<h2>
				<a href="index.html">Home</a><label>/</label>Products
			</h2>
		</div>
	</div>
	<!--content-->
				...
				<div class="mid-popular">
					...
					<div class="col-md-4 item-grid1 simpleCart_shelfItem">
						<div class=" mid-pop">
							<div class="pro-img">
								<img
									src="${pageContext.request.contextPath}/resources/images/${product.imageName}"
									class="img-responsive" alt="">
								<div class="zoom-icon ">
									<a class="picture"
										href="${pageContext.request.contextPath}/resources/images/pc.jpg"
		...
		<div class="footer-bottom">
			<div class="container">
				<ul class="footer-bottom-top">
					<li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/f1.png"
							class="img-responsive" alt=""></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/f2.png"
							class="img-responsive" alt=""></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/f3.png"
							class="img-responsive" alt=""></a></li>
				</ul>
	...
	<link rel="stylesheet" href="${ainCss}/chocolat.css" type="text/css" media="screen" charset="utf-8">
	<!--light-box-files -->
