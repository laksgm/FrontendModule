    ...
    <table class="table">
      ...
      <c:forEach items="${productList}" var="product">
        <tr>
         ...
         <td><button class="btn btn-danger btn-xs" onclick="location.href='${pageContext.request.contextPath}/deleteProduct/${product.productID}'">Delete</button></td>
         <td><button class="btn btn-success btn-xs" onclick="location.href='${pageContext.request.contextPath}/updateProduct/${product.productID}'">Edit</button></td>
        </tr>
       </c:forEach>
